...
class LinkedBinaryTree:
    ...
    def __add__(self, other):
        ...
        #Creates a new binary tree merging tree1 and
        #tree2 and returns its root.
            if(len(self) == 1 and len(other) == 1):
                self.data += other.root.data
            
            if(root1.left.is_empty() is not True and root2.left.is_empty() is not True):
                #root1 = root1 + root2
                root1.
            elif(root1.is_empty() is True and root2.is_empty() is not True):
                root1 = root2
